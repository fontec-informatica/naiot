...
/* Logo — maior que a barra, alinhada ao topo, transborda abaixo */
.hdr-logo { flex-shrink: 0; display: flex; align-self: flex-start; }
.hdr-logo img { height: clamp(80px, 10vw, 110px); width: auto; mix-blend-mode: multiply; }
.hdr-logo-txt {
...
.hero {
  min-height: 100svh;
  display: flex; align-items: center; justify-content: center;
  text-align: center; padding: clamp(140px, 16vw, 170px) clamp(18px,4vw,36px) 60px;
