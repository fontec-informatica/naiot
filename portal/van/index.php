  ...
  <div class="van-cards" style="display:none">
    ...
    <div class="form-wrap" style="margin-bottom:12px">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:8px;gap:8px">
        ...
        <span style="
          flex-shrink:0;padding:2px 8px;border-radius:20px;font-size:.72rem;font-weight:600;
      ...
      <div style="font-size:.82rem;margin-bottom:10px">
        Motorista: <?= htmlspecialchars($v['motorista_nome'] ?? '—') ?><br>
        <?php if ($v['coordenador_nome']): ?>
          Coordenador: <?= htmlspecialchars($v['coordenador_nome']) ?><br>
        <?php endif; ?>
